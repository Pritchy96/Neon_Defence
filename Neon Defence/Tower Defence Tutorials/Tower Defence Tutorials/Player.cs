...
namespace Tower_Defence_Tutorials
{
    public class Player
    {
        ...
        //Constructor
        public Player(Level level, Texture2D[,] towerTextures, Texture2D bulletTexture, Texture2D laserTexture, Texture2D radiusTexture)
        {
        ...
        public void DrawPreview(SpriteBatch spriteBatch)
        {
            ...
            if (string.IsNullOrEmpty(newTowerType) == false)
            {
                ...
                Texture2D previewTexture = towerTextures[newTowerIndex, 0];
